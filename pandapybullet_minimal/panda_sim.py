...
class PandaSim(object):
    ...
    # Source:
    # https://github.com/bulletphysics/bullet3/blob/master/examples/pybullet/gym/pybullet_robots/panda/panda_sim_grasp.py
    # Lines 130-132
    def actuate_gripper(self, opening_width, force):
        for joint_id in [10,11]:
    ...
    # def send_gripper_position(self, q):
    #     p.setJointMotorControlArray(bodyUniqueId=self.robot_id,
    #                                 jointIndices=np.arange(9, 10),
